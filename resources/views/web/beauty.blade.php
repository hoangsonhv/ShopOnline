                    ...
                    <div class="col-xs-12">
                        <div class="bradcaump__inner">
                            <nav class="bradcaump-inner">
                                ...
                                <span class="breadcrumb-item active">Beauty</span>
                            </nav>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="htc__product__rightidebar">
                        ...
                        <div class="row">
                            <div class="shop__grid__view__wrap">
                                <div role="tabpanel" id="grid-view" class="single-grid-view tab-pane fade in active clearfix" style="margin-bottom: 50px">
